...
public class FreeController {
    ...
    public void imageUpload(HttpServletRequest request,
        ...
        try{
            ...
            //이미지 경로 생성
            String path = "D:\\kuyejin\\spring\\pro03\\src\\main\\webapp\\resources\\upload" + "ckImage/"; // 이미지 경로 설정(폴더 자동 생성)
    ...
    public void ckSubmit(@RequestParam(value="uid") String uid
        ...
        //서버에 저장된 이미지 경로
        String path = "D:\\kuyejin\\spring\\pro03\\src\\main\\webapp\\resources\\upload" + "ckImage/"; // 저장된 이미지 경로
